...
public class Modify_Graph_Edge_Weights {
    ...
    class Pair {
        ...
        public Pair(Integer n, Integer wt) {
            this.n = n;
            this.wt = wt;
        }
    }
    ...
    public static int[][] modifiedGraphEdges(int n, int[][] edges, int src, int dest, int target) {
    ...
    public static void createAdjacencyList(int n, int[][] edges) {
        for (int i = 0; i < n; i++) {
