// https://leetcode.com/problems/find-the-safest-path-in-a-grid/description/?envType=daily-question&envId=2024-05-15https://leetcode.com/problems/find-the-safest-path-in-a-grid/description/?envType=daily-question&envId=2024-05-15
...
public class Find_the_Safest_Path_in_a_Grid {
    ...
    public static void main(String[] args) {
        ...
        grid.add(List.of(0, 1, 0, 0, 0, 0));
        grid.add(List.of(0, 1, 0, 0, 0, 0));
        grid.add(List.of(0, 1, 0, 0, 0, 0));
        grid.add(List.of(0, 1, 0, 0, 0, 0));
        grid.add(List.of(0, 0, 0, 0, 0, 0));
        grid.add(List.of(0, 0, 0, 0, 0, 0));
    ...
    private static boolean check(int[][] distNearestThief, int sf) {
        Queue<int[]> que = new LinkedList<>();
        boolean[][] visited = new boolean[n][n];
